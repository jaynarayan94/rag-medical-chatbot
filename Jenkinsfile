pipeline {
    ...
    environment {
        ...
        IMAGE_TAG = 'latest'
        SERVICE_NAME = 'rag-medical-chatbot-service'
    }
        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token1', url: 'https://github.com/jaynarayan94/rag-medical-chatbot.git']])
                }
            }
        }
